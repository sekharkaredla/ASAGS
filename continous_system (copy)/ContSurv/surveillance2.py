    ...
    def doSurveillanceFromVideo(self):
		...
		temp = pred[0][0]
                ...
                if pred == 1:
                    ...
                    print 'violent       '+str(temp)+'      at '+str(int(time_violence))+' seconds , processing time : ' + str(time.time() - video_time_start)
		else:
			print 'non-violent   '+str(temp)+'  '
	print 'video processed in  '+str(time.time() - video_time_start)+' seconds'
